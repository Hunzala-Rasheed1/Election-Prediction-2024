...
import numpy as np
import time
from preprocessing import Vote_distribution_preprocessed,Result_2024,NA_list_preprocessed
from la import l2_Exact, l1_LP
from ml import bo_parameter_serach
from model import final_model, final_models

df_NA_list_2024 = NA_list_preprocessed()
#==============================================================================
#  processes on real results taken from Pakistan's Election Commission           
#==============================================================================
def real_results():
    df_NA_list = Result_2024()
...
def results_province():
    real_result = pd.read_csv("data\\Election_2024_Stats\\Election_result_2024.csv")
...
def compare_methods(method):
    ...
    if method == "L1-LP":
        party_wise_result, seat_wise_result = final_models(paras[:12])
    elif method in ["L2-EX", "L2-BO", "L1-BO"]:
