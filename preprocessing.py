...
def Vote_distribution_preprocessed():
    df_NA_voter_dist = pd.read_csv("data\\Election_2024_Stats\\Voter_Distribution_Lat_Lng.csv")
...
def NA_list_preprocessed():                    
    df_NA_list = pd.read_csv("data\\Election_2024_Stats\\NA_List.csv")
...
def Perevious_results_preprocessed():
    df_election_result_97 = pd.read_csv("data\\Perevious_Results\\election_results_2002.csv")
    df_election_result_2002_13 = pd.read_csv("data\\Perevious_Results\\election_results_2002-2018.csv")

    frames = [df_election_result_97,df_election_result_2002_13]
    df_perevious_results = pd.concat(frames)
    df_election_result_2002_13 = df_perevious_results
    df_perevious_results.to_csv("data\Perevious_Results\election_result123")
    df_perevious_results = pd.read_csv("data\Perevious_Results\election_results_2002.csv")
    df_perevious_results = pd.read_csv("data\Perevious_Results\election_result123.csv")
    df_perevious_results =df_election_result_2002_13
...
#==============================================================================
# Preprocessed result 2024
# 
#==============================================================================
def Result_2024():
    df_result_2024 = pd.read_csv("C:\projects\pythonProject\GE2024\data\Election_2024_Stats\Election_result_2024.csv")
    df_result_2024 = pd.read_csv("data\\Election_2024_Stats\\Election_result_2024.csv")
    df_NA_18 = pd.read_csv("C:\\projects\\pythonProject\\GE2024\\election_prediction\\data\\\Election_2024_Stats\\NA_list.csv")
    df_NA_18 = pd.read_csv("data\\Election_2024_Stats\\NA_list.csv")
    # fill na values with values above
    df_result_2024 = df_result_2024.fillna(method="ffill")
    ...
    df_result_2024['results__party'].replace(replacements, inplace=True)
